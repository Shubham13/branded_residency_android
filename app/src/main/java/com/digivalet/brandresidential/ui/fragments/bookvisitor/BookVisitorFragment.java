...
import com.digivalet.brandresidential.databinding.FragmentBookVisitorBinding;
import com.digivalet.brandresidential.helpers.CustomItemClickListener;
import com.digivalet.brandresidential.ui.adapters.DateSelectorAdapter;
import com.digivalet.brandresidential.ui.adapters.GuestTypeAdapter;
import com.digivalet.brandresidential.ui.bottomsheets.CalenderBottomDialogFragment;
import com.digivalet.brandresidential.ui.bottomsheets.RepeatBottomDialogFragment;
import com.digivalet.brandresidential.ui.bottomsheets.TimeBottomDialogFragment;
import com.digivalet.brandresidential.ui.fragments.guestsprofile.GuestsProfileFragment;
import com.digivalet.brandresidential.ui.fragments.registerguest.RegisterGuestFragment;
...
public class BookVisitorFragment extends BaseFragment<FragmentBookVisitorBinding, BookVisitorViewModel> implements BookVisitorNavigator {
    ...
    private com.digivalet.brandresidential.helpers.GuestType type;
    ...
    public void setGuestTypeData(GuestType guestType) {
        type = com.digivalet.brandresidential.helpers.GuestType.ONE_TIME_GUEST;
            ...
            public void onItemClickListener(int position) {
                switch (position) {
                    case 0:
                        ...
                        break;
                    case 1:
                        type = com.digivalet.brandresidential.helpers.GuestType.FREQUENT_GUEST;
                        onFrequentGuestClick();
                        break;
                    case 2:
                        type = com.digivalet.brandresidential.helpers.GuestType.SHORT_STAYING_GUEST;
