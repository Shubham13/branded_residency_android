...
import com.paragon.sensonic.helpers.ErrorMessage;
...
import com.paragon.brdata.dto.Identification;
...
public class ResidentDetailsFragment extends BaseFragment<FragmentResidentDetailsBinding, ResidentDetailsViewModel>
    ...
    private final ResidentsRelationMapper data;
    ...
    public ResidentDetailsFragment(ResidentsRelationMapper data, ProfileMode mode) {
        this.data = data;
        this.mode = mode;
    }
        ...
        binding.editIdNumber.setOnEditorActionListener((textView, i, keyEvent) -> {
            if (i == EditorInfo.IME_ACTION_NEXT) {
                if (TextUtils.isEmpty(textView.getText().toString())) {
                    DVDialog.showGeneralDialog(getContext(), getString(R.string.label_alert), ErrorMessage.idNumber.getValue(), getString(R.string.label_ok), null);
                }
                return true;
            }
        ...
        rowResidentInfoBinding.editName.setOnEditorActionListener((textView, i, keyEvent) -> {
            if (i == EditorInfo.IME_ACTION_NEXT) {
                if (TextUtils.isEmpty(rowResidentInfoBinding.editName.getText().toString())) {
                    DVDialog.showGeneralDialog(getContext(), getString(R.string.label_alert), ErrorMessage.name.getValue(), getString(R.string.label_ok), null);
                } else {
        ...
        rowResidentInfoBinding.editPreferredName.setOnEditorActionListener((textView, i, keyEvent) -> {
            if (i == EditorInfo.IME_ACTION_NEXT) {
                if (TextUtils.isEmpty(rowResidentInfoBinding.editPreferredName.getText().toString())) {
                    DVDialog.showGeneralDialog(getContext(), getString(R.string.label_alert), ErrorMessage.preferredName.getValue(), getString(R.string.label_ok), null);
                } else {
        ...
        rowContactInfoBinding.editMobileNo.setOnEditorActionListener((textView, i, keyEvent) -> {
            if (i == EditorInfo.IME_ACTION_NEXT) {
                if (!GeneralFunctions.isValidMobileNumber(rowContactInfoBinding.editMobileNo.getText().toString())) {
                    DVDialog.showGeneralDialog(getContext(), getString(R.string.label_alert), ErrorMessage.mobileNumber.getValue(), getString(R.string.label_ok), null);
                } else {
        ...
        rowContactInfoBinding.editEmail.setOnEditorActionListener((textView, i, keyEvent) -> {
            if (i == EditorInfo.IME_ACTION_NEXT) {
                if (!GeneralFunctions.isEmailValid(rowContactInfoBinding.editEmail.getText().toString().trim())) {
                    DVDialog.showGeneralDialog(getContext(), getString(R.string.label_alert), ErrorMessage.email.getValue(), getString(R.string.label_ok), null);
                } else {
        ...
        rowContactInfoBinding.editAltAddress.setOnEditorActionListener((textView, i, keyEvent) -> {
            if (i == EditorInfo.IME_ACTION_NEXT) {
                if (TextUtils.isEmpty(rowContactInfoBinding.editAltAddress.getText().toString())) {
                    DVDialog.showGeneralDialog(getContext(), getString(R.string.label_alert), ErrorMessage.address.getValue(), getString(R.string.label_ok), null);
                } else {
