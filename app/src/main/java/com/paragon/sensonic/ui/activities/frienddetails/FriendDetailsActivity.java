...
import com.paragon.sensonic.databinding.ActivityResidentDetailsBinding;
...
public class FriendDetailsActivity extends BaseActivity<ActivityResidentDetailsBinding, FriendDetailsViewModel>
    ...
    @Override
    public void init() {
        data = (FriendsData) getIntent().getSerializableExtra("data");
