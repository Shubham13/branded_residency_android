package com.paragon.sensonic.ui.fragments.frienddetails;
...
public class FriendDetailsFragment extends BaseFragment<FragmentResidentDetailsBinding, FriendDetailsViewModel>
        implements FriendDetailsNavigator {

    private final FriendDetailsViewModel friendDetailsViewModel = new FriendDetailsViewModel();
    ...
    private final FriendsData data;
    ...
    public FriendDetailsFragment(FriendsData data, ProfileMode mode) {
        this.data = data;
        this.mode = mode;
    }
    ...
    @Override
    public FriendDetailsViewModel getViewModel() {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        friendDetailsViewModel.setNavigator(this);
    }

    @Override
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        friendDetailsViewModel.init();
    }
