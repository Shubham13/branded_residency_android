...
public class SpringAnimator {
    ...
    private SpringListener springAnimatorListener;
    private int delay = 0;
     ...
     *
     * @param type       SpringAnimationType instance for animation type
    ...
    public SpringAnimator(SpringAnimationType type, double tension,
     ...
     * @param endValue   where animation ends to
     **/
    public SpringAnimator(SpringAnimationType type, float startValue,
                          float endValue) {
    ...
    /**
     * @param delay int value  for SpringAnimation delay each item if we have multiple items in
     *              animation  raw.
     **/
    ...
    /*
     * Spring Listener to track the Spring
     * */
    public void setSpringListener(SpringListener springListener) {
        this.springAnimatorListener = springListener;
    }
