package com.digivalet.utils.expandable;
...
public abstract class ExpandableRecyclerAdapter<PVH extends ParentViewHolder, CVH extends ChildViewHolder>
    ...
    private final List<? extends ParentListItem> mParentItemList;
     ...
     *
     * @param holder The RecyclerView.ViewHolder to bind brdata to
     ...
     * <p>
     * Bind brdata to the {@link PVH} here.
     *
     * @param parentViewHolder The {@code PVH} to bind brdata to
     * @param position The index in the list at which to bind
     * @param parentListItem The {@link ParentListItem} which holds the brdata to
     ...
     * <p>
     * Bind brdata to the {@link CVH} here.
     *
     * @param childViewHolder The {@code CVH} to bind brdata to
     * @param position The index in the list at which to bind
     * @param childListItem The child list item which holds that brdata to be
     ...
     * brdata set are still considered up to date and will not be rebound, though their
     * positions may be altered.
     *
     * @param parentPosition Position of the newly inserted ParentListItem in the brdata set, relative
     ...
     * <p>
     * This is a structural change event. Representations of other existing items in the
     * brdata set are still considered up to date and will not be rebound, though their positions
     * may be altered.
     *
     ...
     * has been removed from the brdata set. The ParentListItems previously located at and after
     ...
     * at {@code parentPositionStart} have been removed from the brdata set. The ParentListItems
     ...
     * @param itemCount Number of ParentListItems removed from the brdata set
     */
     ...
     * reflection of the brdata at {@code parentPosition} is out of date and should be updated.
     ...
     * <p>
     * This is an item change event, not a structural change event. It indicates that any
     * reflection of the brdata in the given position range is out of date and should be updated.
     ...
     * has a child list item that has been removed from the brdata set, previously located at {@code childPosition}.
    ...
    /**
     * Notify any registered observers that the ParentListItem located at {@code parentPosition}
     * has {@code itemCount} child list items that have been removed from the brdata set, previously
     ...
     * <p>
     * This is an item change event, not a structural change event. It indicates that any
     * reflection of the brdata at {@code childPosition} is out of date and should be updated.
