package com.digivalet.utils.views.iosprogress;
...
public class IOSProgress {
    ...
    public IOSProgress(Context context) {
        ...
        mWindowColor = context.getResources().getColor(R.color.Black);
        mAnimateSpeed = 1;
        mCornerRadius = 10;
        mIsAutoDismiss = true;
        mGraceTimeMs = 0;
  ...
  /**
   * Create a new HUD. specify the HUD style (if you use a custom view, you need {@code IOSProgress.create(Context context)}).
   *
   * @param context Activity context that the HUD bound to
   * @param style One of the IOSProgress.Style values
   * @return An unique HUD instance
   */
     ...
     * button. If you pass null, the image_picker_dialog won't be cancellable, just like
    ...
    private class ProgressDialog extends Dialog {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.ios_progress);
        ...
        private void initViews() {
            mBackgroundLayout = (BackgroundLayout) findViewById(R.id.root);
