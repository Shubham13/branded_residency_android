package com.digivalet.utils.views.toggle;
...
import com.digivalet.utils.views.toggle.model.ToggleableView;
...
public class LabeledSwitch extends ToggleableView {
    ...
    private void initView() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
            colorBorder = colorOn = getResources().getColor(R.color.toggle_on, getContext().getTheme());
        } else {
            colorBorder = colorOn = getResources().getColor(R.color.toggle_on);
        }
    ...
    private void initProperties(AttributeSet attrs) {
        ...
        for (int i = 0; i < N; ++i) {
            ...
            if (attr == R.styleable.Toggle_on) {
                ...
                int accentColor;
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
                    accentColor = getResources().getColor(R.color.toggle_on, getContext().getTheme());
                } else {
                    accentColor = getResources().getColor(R.color.toggle_on);
                }
...
//Drawing Switch Labels here
    ...
    /**
     * Call this views's OnClickListener, if it is defined.  Performs all normal
