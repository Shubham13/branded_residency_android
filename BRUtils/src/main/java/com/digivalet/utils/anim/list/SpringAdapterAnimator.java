package com.digivalet.utils.anim.list;
...
public class SpringAdapterAnimator {
    ...
    private SpringAdapterAnimationType animationType;
    ...
    public SpringAdapterAnimator(RecyclerView recyclerView) {
        ...
        animationType = SpringAdapterAnimationType.SLIDE_FROM_BOTTOM;
    ...
    public void setSpringAnimationType(SpringAdapterAnimationType type) {
        animationType = type;
    }
    ...
    /**
     * onSpringItemCreate call in Adapter's Constructor method
     *
    ...
    /**
     * * onSpringItemBind call in RecyclerView's onBind for scroll effects
     *
